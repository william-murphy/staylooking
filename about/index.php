...
<body>
    ...
    <main>
        ...
        <p class="content-p"> StayLooking is a fashion based image sharing service. Users can upload
        ...
        <p class="content-p"> My name is Will Murphy, a high school student from Massachusetts.
