    ...
    <main>
        ...
        <h1 class="content-main-heading">Help</h1>
            ...
            <h2 class="content-heading">Why does something not work?</h2>
                ...
                <p class="content-p">Because I need to fix it, please email me
            ...
            <h2 class="content-heading">Why am I banned?</h2>
                ...
                <p class="content-p">Each post is allowed 10 reports
                    ...
                    banning system, go <a class="content-link" href="http://staylooking.com/help/bannedaccount/">here</a></p>

            <h2 class="content-heading">How do I delete my account?</h2>

                <p class="content-p">If you wish to delete your account
                    for whatever reason at all, go <a class="content-link" href="http://staylooking.com/help/deleteaccount/">here</a></p>

            <h2 class="content-heading">How can I retrieve a forgotten username or password?</h2>

            <p class="content-p">If you have forgotten your username or
                password and need to retrieve either, go <a class="content-link" href="http://staylooking.com/help/forgotpassword/">here</a></p>
